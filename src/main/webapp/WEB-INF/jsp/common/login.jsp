...
<div class="container shadow-lg p-3 mb-5 bg-white rounded" style="margin-top:160px;width: 600px">
    ...
    <div class="mx-auto" style="width:500px">
        <h2 class="text-center"><fmt:message key="login_jps.h.login"/></h2>
        <form action="home" method="post">
            <input type="hidden" name="command" value="login"/>
            <div class="form-group">
                <fmt:message key="login_jps.placeholder.email" var="placeholder_email"/>
                <label for="number"><fmt:message key="login_jps.label.email"/></label>
                <input type="text" maxlength="9" class="form-control" id="number" placeholder="${placeholder_email}"
